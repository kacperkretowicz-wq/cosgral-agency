/**
 * Realizacje — Collaboration-shell horizontal cards (Pinterest inspo).
 */
(function () {
  "use strict";
  ...
  function setActive(index, opts) {
    ...
    document.body.setAttribute("data-tile-theme", tile.getAttribute("data-theme") || "web");
    syncFoot(tile);
    syncVideos(tile);
    playTileSlides(tile);
  }
  ...
  document.addEventListener("cosgral:langchange", function () {
    if (activeIndex >= 0) syncFoot(tiles[activeIndex]);
  });
})();

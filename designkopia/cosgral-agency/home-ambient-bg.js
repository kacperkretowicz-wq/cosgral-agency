...
(function () {
  ...
  /* Android / low-end: pełnoekranowy WebGL + CSS blur tnie klatki — zostaw CSS tło. */
  if (MOBILE) {
    canvas.remove();
    var blur = document.querySelector(".home-ambient__blur");
    if (blur) blur.remove();
    document.documentElement.classList.add("is-ambient-off");
    return;
  }

/* Original, lightweight motion layers for the three illustrative product stills — B&W monochrome. */
(() => {
  const overlays = {
    ...
    code39: `<defs><linearGradient id="tf-code-scan"><stop stop-color="#FFFFFF" stop-opacity="0"/><stop offset=".48" stop-color="#FFFFFF" stop-opacity=".15"/><stop offset=".5" stop-color="#FFFFFF" stop-opacity=".65"/><stop offset=".52" stop-color="#FFFFFF" stop-opacity=".15"/><stop offset="1" stop-color="#FFFFFF" stop-opacity="0"/></linearGradient></defs>
